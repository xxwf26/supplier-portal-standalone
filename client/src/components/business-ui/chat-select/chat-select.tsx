...
import { searchChats } from '@/components/business-ui/api/chats/service';
import { ChatItem } from '@/components/business-ui/chat-select/chat-item';
import { ChatSelectTag } from '@/components/business-ui/chat-select/chat-select-tag';
import type {
  Chat,
  ChatSelectProps,
} from '@/components/business-ui/chat-select/types';
import { useChatValue } from '@/components/business-ui/chat-select/use-chat-value';
import { chatInfoToChat } from '@/components/business-ui/chat-select/utils';
