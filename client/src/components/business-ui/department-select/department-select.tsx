...
import { searchDepartments } from '@/components/business-ui/api/departments/service';
import { DepartmentItem } from '@/components/business-ui/department-select/department-item';
import { DepartmentSelectTag } from '@/components/business-ui/department-select/department-select-tag';
import type {
  Department,
  DepartmentSelectProps,
} from '@/components/business-ui/department-select/types';
import { departmentInfoToDepartment } from '@/components/business-ui/department-select/utils';
