...
import { IconDepartment } from '@/components/business-ui/department-select/icon-department';
import type { Department } from '@/components/business-ui/department-select/types';
import { ItemPill } from '@/components/business-ui/entity-combobox/item-pill';
import {
